...
namespace IdentityAdmin.Migrations
{
    ...
    [Migration("20241121185354_permissiontableadded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityAdmin.Entity.UserRolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IdentityAdmin.Entity.UserRolePermission", b =>
                {
                    b.HasOne("IdentityAdmin.Entity.UserRole", "UserRole")
                        .WithOne("UserRolePermission")
                        .HasForeignKey("IdentityAdmin.Entity.UserRolePermission", "UserRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
